...
function initRestabook() {
    ...
    $(".image-collage-item").each(function () {
        var tcp = $(this),
    ...
    if ($(".testim-caro").length > 0) {
        var j2 = new Swiper(".testim-caro .swiper-container", {
            preloadImages: false,
            slidesPerView: 3,
            spaceBetween: 30,
            loop: true,
    ...
    function mobMenuInit() {
        ...
        if (ww < 1048) {
            ...
            $(".main-menu .navbar-1").clone().addClass("menusb").appendTo(".main-menu");
            $(".menusb").menu();
            $(".menusb.scroll-init a").on("click", function () {
                $(".main-menu").removeClass("vismod");
            });
        } else {
            $(".menusb").remove();
